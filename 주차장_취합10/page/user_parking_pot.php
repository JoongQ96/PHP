...
<?php
}else if($_SESSION['carnum_front'] == '관리자') {    
   ?>
      <script>
         // 관리자가 아닐 경우 사용자 페이지로 이동
...
// 로그인한 사용자의 차량번호의 위치 정보를 area에 저장
      ...
      <div id="header">
         ...
         <div id="menu">
            <ul>
               ...
               <li class="current_page_item"><a href="user_parking_pot.php" accesskey="2" title="">사용자 차량 위치</a></li>
            </ul>
         </div>
      </div>
      <div id="main">
