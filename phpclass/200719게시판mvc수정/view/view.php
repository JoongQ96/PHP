                ...
                <td colspan="2">
                    ...
                    if ($searchKeyword != null){    // list에서 검색 한 경우
                        echo "<input type='button' name='list' value='글 목록' 
                              onclick=\"location.href='boardController.php?board_id={$boardValue->board_id}&keyword={$searchKeyword}&searchText={$searchText}&searchBtn={$searchBtn}&nowPage={$nowPage}'\">";
                    } else{
                        if ($nowPage != null){      // list에서 검색 안한 경우, nowPage 있을때
                            echo "<input type='button' name='list' value='글 목록' onclick=\"location.href='boardController.php?nowPage={$nowPage}'\">";
                        } else{                     // list에서 검색 안한 경우, nowPage 없을때, 즉 default page
                            echo "<input type='button' name='list' value='글 목록' onclick=\"location.href='boardController.php?nowPage=1'\">";
                        }
                    }
                    ?>
