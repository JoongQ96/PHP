...
<fieldset style="width: 50%">
    <legend>글쓰기</legend>
    <form name="loginForm" action="<?php echo BoardInfo::FILENAME_WRITE_PROCESS; ?>" method="get">
        <table>
            <tr><td>제목</td><td><input type='text' size='50%' name='title'></td></tr>
            <tr><td>작성자</td><td><input type='text' size='50%' name='name'></td></tr>
            <tr><td>비밀번호</td><td><input type='text' size='50%' name='password'></td></tr>
