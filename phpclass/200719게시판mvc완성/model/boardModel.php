...
class board_Query extends commonFunc {
    ...
    public function listQuery($clickPageButton, $showTextNum, $searchKeyword, $searchText){
        ...
        while ($showRow = $pagingSqlResult->fetch_array()){
            ...
            if ($searchKeyword == null){    // 검색을 안한 경우
                ...
                echo "<td><a href='../controller/viewController.php?board_id={$showRow['board_id']}&keyword={$searchKeyword}&searchText={$searchText}&searchBtn=검색&thisPage={$clickPageButton}
