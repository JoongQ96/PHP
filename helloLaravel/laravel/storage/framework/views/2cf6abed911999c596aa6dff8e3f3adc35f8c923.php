<?php $__env->startSection('title', '글 수정'); ?>
...
unset($__errorArgs, $__bag); ?>" type="text" name="title" id="title" value="<?php echo e(old('title') ? old('title') : $writer->title); ?>" required><br>
...
unset($__errorArgs, $__bag); ?>" name="body" id="body" cols="30" rows="10" required value="<?php echo e($writer->contents); ?>"></textarea><br>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\helloLaravel\laravel\resources\views/writer/edit.blade.php ENDPATH**/ ?>